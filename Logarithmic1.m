...
if nargin==0
   p=[0.1;3;10/3]; q=[2;0.5;1];
   
   clf;
   fsurf(@(x,y) 1/(x*y) ,[0.05 3]); hold on; grid on;
   plot3(q(1),q(2),q(3),'-*');
   zlim([0 3.5]);
   ylim([0 3])
   xlim([0 3])
